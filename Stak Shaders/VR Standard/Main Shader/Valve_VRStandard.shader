	...
	SubShader
	{
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 lerpResult438 = lerp( ( lerpResult289 * lerpResult287 * lerpResult286 * lerpResult288 ) , temp_cast_2 , temp_output_178_0);
...
/*ASEBEGIN
Version=18800
424;73;1040;562;1701.921;1341.213;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;439;-1438.921,-1157.213;Inherit;False;Constant;_Float4;Float 4;50;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
WireConnection;438;0;291;0
WireConnection;438;1;439;0
WireConnection;438;2;178;0
...
ASEEND*/
//CHKSM=C32ECECDC54D52944841D05E8863F6D770C0AA0F