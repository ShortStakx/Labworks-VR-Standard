	...
	SubShader
	{
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 lerpResult438 = lerp( ( lerpResult289 * lerpResult287 * lerpResult286 * lerpResult288 ) , float4( 0,0,0,0 ) , temp_output_178_0);
...
/*ASEBEGIN
Version=18800
424;73;1040;562;1973.24;1434.495;1.534044;True;True
...
Node;AmplifyShaderEditor.LerpOp;438;-1329.957,-1171.728;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=7F68A4D9FE0A4675B92764093E5E7DD7E18D1526