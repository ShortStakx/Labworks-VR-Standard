...
half4 frag(VertOut i) : SV_Target
{
	...
	#if ( _COLORMASK_ON )
	{
		...
		half ao = mas.g;
		half smoothness = mas.b * _Glossiness;

	#elif defined(_METALLICTYPE_METALLICSMOOTHNESS)
		half metallic = mas.r + _Metallic;
		half ao = 1;
		half smoothness = mas.a * _Glossiness;

	#elif defined(_METALLICTYPE_RMA)
		half metallic = mas.g + _Metallic;
		half ao = mas.b;
		half smoothness = (1 - mas.r) * _Glossiness
	...
	#elif defined(_METALLICTYPE_FLOATS)
