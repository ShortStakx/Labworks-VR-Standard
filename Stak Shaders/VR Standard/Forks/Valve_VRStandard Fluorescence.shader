...
Shader "Valve/VR Fluorescence"
{
	Properties
	{
		...
		_Absorbance("Absorbance", Color) = (0.5882353,0.7843137,0.8666667,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_9_0_g133 = tex2D( _DetailMask, OffsetPOM398 ).r;
				float temp_output_18_0_g133 = ( 1.0 - temp_output_9_0_g133 );
				float3 appendResult16_g133 = (float3(temp_output_18_0_g133 , temp_output_18_0_g133 , temp_output_18_0_g133));
				#ifdef _HMMMDETAIL_ON
				float4 staticSwitch199 = float4( ( staticSwitch293.rgb * ( ( ( tex2D( _DetailAlbedoMap, OffsetPOM398 ).rgb * (unity_ColorSpaceDouble).rgb ) * temp_output_9_0_g133 ) + appendResult16_g133 ) ) , 0.0 );
				#else
...
/*ASEBEGIN
Version=18800
424;73;1040;562;503.5846;387.2075;1.206472;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;203;-3209.844,-1665.173;Inherit;False;1894.306;888.598;;7;183;184;186;187;185;189;188;Fluorescence;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;181;411.0699,-1003.488;Inherit;False;BRDFMap;29;;134;1affaac2d6e57354aaa8d6573a2b32b8;0;1;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;190;93.64596,-251.0789;Inherit;False;Property;_Absorbance;Absorbance;35;0;Create;True;0;0;0;False;0;False;0.5882353,0.7843137,0.8666667,0;0.09999994,0.25,0.5,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;280;97.50897,-1404.346;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;438;-985.4881,-625.5735;Inherit;False;Constant;_Float4;Float 4;50;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;179;778.5174,-404.6934;Inherit;False;Detail Albedo;21;;133;29e5a290b15a7884983e27c8f1afaa8c;0;3;12;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;9;FLOAT;0;False;1;FLOAT3;0
...
WireConnection;440;22;190;0
ASEEND*/
//CHKSM=57CA39F0543220E3BBBEF0AD26CD4C84022813ED